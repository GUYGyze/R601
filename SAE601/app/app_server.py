...
def send_server_key(dest_ip="127.0.0.1"):
    ...
    # 3) Envoyer via ICMP
    send_icmp_packet(dest_ip, key_data)
...
def api_send_server_key():
    ...
    dest_ip = data.get("dest_ip", "127.0.0.1")  # IP optionnelle envoyée en JSON
    send_server_key(dest_ip=dest_ip)
